...
var chargeId = exports.chargeId = "ch_000000";
var tokenId = exports.tokenId = "tok_000000";

var country = exports.country = "US";

var routingNumbers = exports.routingNumbers = {
	US: "110000000",
	CA: "11000-000",
	AU: "110000",
	JP: "110000"
...
var defaultCurrency = exports.defaultCurrency = currencies[country];

var cardNumbers = exports.cardNumbers = ["4242424242424242", // Visa
...
// JCB
var cardErrors = exports.cardErrors = ["4000000000000077", // Charge will succeed and funds will be added directly to your available balance (bypassing your pending balance).
...
var accountNumbers = exports.accountNumbers = {
	US: ["000123456789", // Transfer will succeed.
	...
	"000444444440"],
	// Transfer will fail with an invalid_currency code.
	CA: ["000123456789", // Transfer will succeed.
	"000111111116", // Transfer will fail with a no_account code.
	"000111111113", // Transfer will fail with an account_closed code.
	"000222222227", // Transfer will fail with an insufficient_funds code.
	"000333333335", // Transfer will fail with a debit_not_authorized code.
	"000444444440"],
	// Transfer will fail with an invalid_currency code.
	AU: ["000123456", // Transfer will succeed.
	...
	"444444440"],
	// Transfer will fail with an invalid_currency code.
	JP: ["00012345", // Transfer will succeed.
	...
	"44444440"],
	// Transfer will fail with an invalid_currency code.
	EU: ["DE89370400440532013000", // Transfer will succeed.
